...
class Search extends Component {
  ...
  handleChange(e){
    this.setState({search: e.target.value, match:true})
          console.log("this", this.state.data.indexOf(e.target.value))
  ...
  render() {
    return (
        ...
        <div className="search row small-12 medium-8 large-6 columns align-center">
         <input type="search" value={this.state.search} name="search"  placeholder="&#61447;" className="animated-search-form" onChange={this.handleChange} />
